...
ALL_SRCS := $(wildcard Exception/*.hpp) $(wildcard IO/inputItem/*.cpp) $(wildcard IO/inputRecipe/*.cpp) $(wildcard Item/*.cpp) $(wildcard Inventory/*.cpp) $(wildcard Crafting/*.cpp) $(wildcard Player/*.cpp) $(wildcard *.cpp)
